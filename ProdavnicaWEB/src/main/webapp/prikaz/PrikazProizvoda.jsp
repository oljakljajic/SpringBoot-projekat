...
<div class="sidenav">
	...
	<table border="3">
		...
		<tr>
			...
			<td><a href="/Prodavnica/prodavnica/saveOmiljeno?idProizvod=${p.idProizvod}">Dodaj u omiljeno</a></td>
			<td><a href="/Prodavnica/prodavnica/dodajOcenu?idProizvod=${p.idProizvod}">Oceni proizvod</a>
			<c:if test="${p.kolicinaP != 0}">
				<td><a href="/Prodavnica/prodavnica/saveUKorpu?idProizvod=${p.idProizvod}">Kupi</a></td>
			</c:if>
			<c:if test="${p.kolicinaP == 0}">
